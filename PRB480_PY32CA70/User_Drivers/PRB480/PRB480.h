...
#define PRB480_DQ_GPIO_PIN       LL_GPIO_PIN_1
#define PRB480_ADC_CHANNEL       LL_ADC_CHANNEL_0

#define PRB480_RESP_GPIO_PORT    GPIOB
#define PRB480_RESP_GPIO_PIN     LL_GPIO_PIN_3
#define PRB480_POWER_GPIO_PORT   GPIOB
#define PRB480_POWER_GPIO_PIN    LL_GPIO_PIN_4
*/
